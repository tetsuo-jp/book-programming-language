module Sec9_3 where             -- Extended to Sec9_2
...
test7 = string "do" "don't"     -- p.201

test8 = tok number T_Num "31"     -- p.202
test9 = tok (string "do") T_Sym "don't" -- p.202
test10 = lex testprog1
testprog1 = "2 + 3 - 2"
