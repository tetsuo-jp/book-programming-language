...
-- Testing
test1 = exec "begin var n,f; n:=5; f:=1; while n>0 do begin f:=f*n; n:=n-1 end; output f end"
test2 = parse "break"
test3 = exec "begin var n,f; n:=5; f:=1; while n>0 do begin if n==3 then break else skip; f:=f*n; n:=n-1 end; output f end"